                        ...
                        <div class="col-lg-12">
                            <div class="d-widget">
                                <form method="post" enctype="multipart/form-data"
                                    action="/administrator/post/<?php echo e($contents->slug); ?>">
...
unset($__errorArgs, $__bag); ?>
                                                    ...
                                                    <input class="uk-input mb-2"
                                                        value="<?php echo e(old('link', $contents->link)); ?>" name="link" id="link"
...
unset($__errorArgs, $__bag); ?>
                                                    ...
                                                    <?php if($contents->type == "audio"): ?>
                                                    <div class="d-flex justify-content-between mb-1">
                                                        <span>Link Audio Embed</span>
                                                    </div>
                                                    <input class="uk-input mb-2"
                                                        value="<?php echo e(old('link_audio', $contents->link_audio)); ?>" name="link_audio" id="link_audio"
                                                        type="text" placeholder="Link Audio Post">
                                                    <?php $__errorArgs = ['link_audio'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                                ...
                                                <div class="uk-margin uk-grid-small uk-child-width-auto uk-grid">
                                                    <div class="row">
                                                        ...
                                                        <label class="mr-2"><input onchange="edit(this)"
                                                                ...
                                                                value="<?php echo e($item->id); ?>" <?php echo e(is_array($parents) &&
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <p id="cats" style="display: block"><?php echo e($category[0]->name); ?></p>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mike/laravel/gue-muda/resources/views/admin/content-edit.blade.php ENDPATH**/ ?>