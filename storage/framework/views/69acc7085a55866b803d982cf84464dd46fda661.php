<nav class="sidebar">
    <ul class="menu-slide">
        ...
        <li class="<?php echo e(Request::is('administrator/analytic*') ? 'active' : ''); ?>">
...
<!-- sidebar --><?php /**PATH /var/www/guemuda.dewanhoster.my.id/resources/views/partials_admin/sidebar.blade.php ENDPATH**/ ?>