                        ...
                        <div class="col-lg-12">
                            <div class="d-widget">
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <?php $__empty_1 = true; $__currentLoopData = $groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $num => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td><?php echo e(++$num); ?></td>
                                            <td><?php echo e($category->namegroup); ?></td>
                                            <td><?php echo e($category->slug); ?></td>
                                            <td><?php echo e(\Carbon\Carbon::parse($category->created_at)->diffForHumans()); ?>

                                            <td>
                                                <a href="/administrator/communitiesgroup/<?php echo e($category->slug); ?>"
                                                ...
                                                <a href="/administrator/communitiesgroup/<?php echo e($category->slug); ?>/edit"
                                                ...
                                                <form action="/administrator/communitiesgroup/<?php echo e($category->slug); ?>" method="post"
                                                    class="d-inline">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mike/laravel/Gue-Muda/resources/views/admin/community-group.blade.php ENDPATH**/ ?>