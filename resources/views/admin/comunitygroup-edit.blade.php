                        ...
                        <div class="col-lg-12">
                            <div class="d-widget">
                                <form method="post" enctype="multipart/form-data"
                                    action="/administrator/communitiesgroup/{{ $communities->slug }}">
                                    @method('put')
                                    @csrf
                                                    ...
                                                    {{-- <fieldset class="uk-fieldset mt-3"> --}}
                                                        <div class="uk-margin">
                                                            ...
                                                            <input class="uk-input"
                                                                value="{{ old('namegroup', $communities->namegroup) }}"
                                                        ...
                                                        <textarea class="uk-textarea" name="desc" id="createnews"
                                                            rows="12"
                                                            placeholder="Textarea">{{ old('desc', $communities->desc) }}</textarea>
                                            ...
                                            <div class="uk-card uk-card-default uk-card-body">
                                                ...
                                                <div class="uk-card uk-card-hover">
                                                    <div class="input-group flex-nowrap">
                                                        ...
                                                        <input type="text" name="linkwa"
                                                            value="{{ old('desc', $communities->linkwa) }}"
                                                ...
                                                <div class="uk-card uk-card-hover mt-2">
                                                    <div class="input-group flex-nowrap">
                                                        ...
                                                        <input value="{{ old('desc', $communities->linktele) }}"
                                                ...
                                                <div class="uk-card uk-card-hover mt-2">
                                                    <div class="input-group flex-nowrap">
                                                        ...
                                                        <input name="linktwit"
                                                            value="{{ old('desc', $communities->linktwit) }}"
                                                ...
                                                <div class="uk-card uk-card-hover mt-2">
                                                    <div class="input-group flex-nowrap">
                                                        ...
                                                        <input name="linkig"
                                                            value="{{ old('linkig', $communities->linkig) }}"
