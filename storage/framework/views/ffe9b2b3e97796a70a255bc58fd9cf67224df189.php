            ...
            <div class="col-lg-12">
                <div class="panel-content">
                    ...
                    <div class="row merged20 mb-4">
                        <div class="col-lg-12">
                            <div class="d-widget">
                                <form method="post" action="/administrator/roles/<?php echo e($role->id); ?>" class="mb-5"
                                    ...
                                    <div class="d-widget-title">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                <h4>Edit Role <?php echo e($role->name); ?></h4>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="uk-text-center" uk-grid>
                                        <div class="uk-width-expand@m">
                                            <fieldset class="uk-fieldset mt-3">
                                                <div class="uk-margin">
                                                    <input readonly class="uk-input" value="<?php echo e($role->name); ?>"
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="uk-margin uk-grid-small uk-child-width-auto uk-grid">
                                                    <div class="row">
                                                        ...
                                                        <label class="mr-3"><?php echo e(Form::checkbox('permission[]',
                                                            $value->id,
                                                            in_array($value->id, $rolePermissions) ? true : false,
                                                            array('class' => 'uk-checkbox'))); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mike/laravel/Gue-Muda/resources/views/admin/role-edit.blade.php ENDPATH**/ ?>