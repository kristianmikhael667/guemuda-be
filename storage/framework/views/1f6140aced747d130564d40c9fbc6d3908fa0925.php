                        ...
                        <div class="col-lg-12">
                            <div class="d-widget">
                                <form method="post" enctype="multipart/form-data"
                                    action="/administrator/premiumcontent/<?php echo e($slugs); ?>">
                                    <?php echo method_field('put'); ?>
                                    <?php echo csrf_field(); ?>
                                    <div class="d-widget-title">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                <h4>Edit Title Premium Content</h4>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <fieldset class="uk-fieldset mt-3">
                                                <div class="uk-margin">
                                                    <input class="uk-input" value="<?php echo e(old('title', $contents)); ?>"
                                                        name="title" id="title" type="text" placeholder="Title Article">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <button type="submit" class="btn btn-primary">Save Title Premium</button>
                                </form>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mike/laravel/gue-muda/resources/views/admin/premium-title.blade.php ENDPATH**/ ?>