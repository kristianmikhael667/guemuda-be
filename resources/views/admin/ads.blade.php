                        ...
                        <div class="col-lg-12">
                            <div class="d-widget">
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        @forelse ($ads as $num => $ad)
                                        <tr>
                                            <td>{{ $ads->firstItem() + $num }}</td>
                                            <td>{{
                                                $ad->title
                                                }}</td>
                                            <td>{{ $ad->type}}
                                            </td>
                                            <td><span class="text-success">{{ $ad->status }}</span></td>
                                            <td>{{ \Carbon\Carbon::parse($ad->created_at)->diffForHumans() }}
                                            </td>
                                            <td>{{ \Carbon\Carbon::parse($ad->updated_at)->diffForHumans() }}</td>
                                            <td>
                                                <a href="/dashboard/posts/{{ $ad->uuid }}" class="badge btn-light">
                                                ...
                                                <form action="/administrator/ads/{{ $ad->uuid }}" method="post"
                                                    class="d-inline">
                                                    @method('delete')
                                                    @csrf
