                            ...
                            <div class="d-widget">
                                <div class="d-widget-title">
                                    <div class="d-flex justify-content-between">
                                        <div>
                                            <h4>Community Video Management</h4>
                                        </div>
                                        <div>
                                            <a href="/administrator/community-video/create" id="create-new-post"
                                                class="btn btn-primary">Create Community Video</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="d-widget-title">
                                    <div class="d-flex justify-content-between">
                                        <div>
                                            <form action="/administrator/community-video" method="get" role="search">
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <?php $__empty_1 = true; $__currentLoopData = $communities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $num => $community): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <?php 
                                        $explode_id = array_map('intval', explode(',', $community->tags_id));
                                        ?>
                                        <tr>
                                            <td><?php echo e($communities->firstItem() + $num); ?></td>
                                            <td><a
                                                    href="/administrator/community-video/edittitle/<?php echo e($community->slug); ?>"><?php echo e($community->title); ?></a></td>
                                            ...
                                            <td><?php echo e(\Carbon\Carbon::parse($community->updated_at)->diffForHumans()); ?>
                                ...
                                <div class="d-flex justify-content-center">
                                    <?php echo e($communities->links('vendor.pagination.default')); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mike/laravel/Gue-Muda/resources/views/admin/community-video.blade.php ENDPATH**/ ?>