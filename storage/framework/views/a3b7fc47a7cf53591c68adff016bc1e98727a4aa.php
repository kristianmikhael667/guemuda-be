                        ...
                        <div class="col-lg-12">
                            <div class="d-widget">
                                ...
                                <div class="d-widget-title">
                                    <div class="d-flex justify-content-between">
                                        <div>
                                            <form action="/administrator/subscriber" method="get" role="search">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mike/laravel/gue-muda/resources/views/admin/users-subscribe.blade.php ENDPATH**/ ?>