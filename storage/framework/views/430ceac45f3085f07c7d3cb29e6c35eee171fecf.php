                        ...
                        <div class="col-lg-12">
                            <div class="d-widget">
                                <form method="post" enctype="multipart/form-data"
                                    action="/administrator/community-news/<?php echo e($slugs); ?>">
                                    <?php echo method_field('put'); ?>
                                    <?php echo csrf_field(); ?>
                                    <div class="d-widget-title">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                <h4>Edit Title Community Group</h4>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="uk-text-center" uk-grid>
                                        <div class="uk-width-expand@m">
                                            <fieldset class="uk-fieldset mt-3">
                                                <div class="uk-margin">
                                                    <input class="uk-input" value="<?php echo e(old('title', $contents)); ?>"
                                                        name="title" id="title" type="text" placeholder="Title Community">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <button type="submit" class="btn btn-primary">Save Title Community</button>
                                </form>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mike/laravel/gue-muda/resources/views/admin/community-title.blade.php ENDPATH**/ ?>