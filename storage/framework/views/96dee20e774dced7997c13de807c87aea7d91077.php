                        ...
                        <div class="col-lg-12">
                            <div class="d-widget">
                                <form method="post" enctype="multipart/form-data"
                                    action="/administrator/category-premium">
                                    <?php echo csrf_field(); ?>
                                    <div class="d-widget-title">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                <h4>Create Category Premium</h4>
                                            </div>
                                        </div>
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <button type="submit" class="btn btn-primary">Save Category Premium</button>
                                </form>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mike/laravel/Gue-Muda/resources/views/admin/create-category-premium.blade.php ENDPATH**/ ?>