...
<div class="theme-layout">
    @include('partials_superadmin.responsiveheader')
    @include('partials_superadmin.header')
    @include('partials_superadmin.topsubbar')
    @include('partials_superadmin.sidebar')
