                                            ...
                                            <form action="/administrator/post" method="get" role="search">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="title"
                                                        placeholder="Search Media ..." value="<?php echo e(request('title')); ?>">
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <img src="<?php echo e(url('/api/image/'. $item)); ?>" width="100" height="100" alt=""
                                                srcset="">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mike/laravel/gue-muda/resources/views/admin/media.blade.php ENDPATH**/ ?>