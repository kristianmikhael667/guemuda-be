            ...
            <div class="col-lg-12">
                <div class="panel-content">
                    ...
                    <div class="row merged20 mb-4">
                        <div class="col-lg-12">
                            <div class="d-widget">
                                <form method="post" enctype="multipart/form-data" action="/administrator/video-article">
                                    <?php echo csrf_field(); ?>
                                    <div class="d-widget-title">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                <h4>Create Video Article</h4>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <fieldset class="uk-fieldset mt-3">
                                                <div class="uk-margin">
                                                    <input class="uk-input" name="title" id="title" type="text"
                                                        placeholder="Title Video Article">
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="uk-margin">
                                                    <input class="uk-input" name="link" id="link" type="text"
                                                        placeholder="Embed Link Video Article">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mike/laravel/Gue-Muda/resources/views/admin/create-video-article.blade.php ENDPATH**/ ?>