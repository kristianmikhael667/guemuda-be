                                                    ...
                                                    <div class="uk-margin" id="survey-question" style="display: none">
                                                        <div class="uk-margin">
                                                            ...
                                                            <input class="uk-input" name="survey_question1"
                                                                id="question1" type="text" placeholder=<?php echo e(old('survey_question1')); ?>>
...
unset($__errorArgs, $__bag); ?>
                                                        ...
                                                        <div class="uk-margin">
                                                            ...
                                                            <input class="uk-input" name="survey_question2"
                                                                id="question2" type="text" placeholder=<?php echo e(old('survey_question2')); ?>>
...
unset($__errorArgs, $__bag); ?>
                                                        ...
                                                        <div class="uk-margin">
                                                            ...
                                                            <input class="uk-input" name="survey_question3"
                                                                id="question3" type="text" placeholder=<?php echo e(old('survey_question3')); ?>>
...
unset($__errorArgs, $__bag); ?>
                                                        ...
                                                        <div class="uk-margin">
                                                            ...
                                                            <input class="uk-input" name="survey_question4"
                                                                id="question4" type="text" placeholder=<?php echo e(old('survey_question4')); ?>>
...
unset($__errorArgs, $__bag); ?>
                                                        ...
                                                        <div class="uk-margin">
                                                            ...
                                                            <input class="uk-input" name="survey_question5"
                                                                id="question5" type="text" placeholder=<?php echo e(old('survey_question5')); ?>>
...
unset($__errorArgs, $__bag); ?>
                                                        ...
                                                        <div class="uk-margin">
                                                            ...
                                                            <input class="uk-input" name="survey_question6"
                                                                id="question6" type="text" placeholder=<?php echo e(old('survey_question6')); ?>>
...
unset($__errorArgs, $__bag); ?>
                                                        ...
                                                        <div class="uk-margin">
                                                            ...
                                                            <input class="uk-input" name="survey_question7"
                                                                id="question7" type="text" placeholder=<?php echo e(old('survey_question7')); ?>>
...
unset($__errorArgs, $__bag); ?>
                                                        ...
                                                        <div class="uk-margin">
                                                            ...
                                                            <input class="uk-input" name="survey_question8"
                                                                id="question8" type="text" placeholder=<?php echo e(old('survey_question8')); ?>>
...
unset($__errorArgs, $__bag); ?>
                                                        ...
                                                        <div class="uk-margin">
                                                            ...
                                                            <input class="uk-input" name="survey_question9"
                                                                id="question9" type="text" placeholder=<?php echo e(old('survey_question9')); ?>>
...
unset($__errorArgs, $__bag); ?>
                                                        ...
                                                        <div class="uk-margin">
                                                            ...
                                                            <input class="uk-input" name="survey_question10"
                                                                id="question10" type="text" placeholder=<?php echo e(old('survey_question10')); ?>>
...
unset($__errorArgs, $__bag); ?>
                                                        ...
                                                        <div class="uk-margin">
                                                            ...
                                                            <input class="uk-input" name="survey_question11"
                                                                id="question11" type="text" placeholder=<?php echo e(old('survey_question11')); ?>>
...
unset($__errorArgs, $__bag); ?>
                                                        ...
                                                        <div class="uk-margin">
                                                            ...
                                                            <input class="uk-input" name="survey_question12"
                                                                id="question12" type="text" placeholder=<?php echo e(old('survey_question12')); ?>>
...
unset($__errorArgs, $__bag); ?>
                                                        ...
                                                        <div class="uk-margin">
                                                            ...
                                                            <input class="uk-input" name="survey_question13"
                                                                id="question13" type="text" placeholder=<?php echo e(old('survey_question13')); ?>>
...
unset($__errorArgs, $__bag); ?>
                                                        ...
                                                        <div class="uk-margin">
                                                            ...
                                                            <input class="uk-input" name="survey_question14"
                                                                id="question14" type="text" placeholder=<?php echo e(old('survey_question14')); ?>>
...
unset($__errorArgs, $__bag); ?>
                                                        ...
                                                        <div class="uk-margin">
                                                            ...
                                                            <input class="uk-input" name="survey_question15"
                                                                id="question15" type="text" placeholder=<?php echo e(old('survey_question15')); ?>>
                                                ...
                                                <div class="uk-margin uk-grid-small uk-child-width-auto uk-grid">
                                                    <div class="row">
                                                        <label class="mr-2"><input class="uk-radio" name="typewebinar"
                                                                id="typewebinar1" value="0" type="radio">
                                                            Umum</label>
                                                        <label class="mr-2"><input class="uk-radio" name="typewebinar"
                                                                id="typewebinar2" value="1" type="radio">
                                                            Premium</label>
                                                    </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mike/laravel/gue-muda/resources/views/admin/create-webinars.blade.php ENDPATH**/ ?>