                            ...
                            <div class="d-widget">
                                <div class="d-widget-title">
                                    <div class="d-flex justify-content-between">
                                        <div>
                                            <h4>Video Article Management</h4>
                                        </div>
                                        <div>
                                            <a href="/administrator/video-article/create" id="create-new-post"
                                                class="btn btn-primary">Create Video</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="d-widget-title">
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <?php $__empty_1 = true; $__currentLoopData = $videos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $num => $content): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <?php 
                                        $explode_id = array_map('intval', explode(',', $content->tags_id));
                                        ?>
                                        <tr>
                                            <td><?php echo e($videos->firstItem() + $num); ?></td>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mike/laravel/Gue-Muda/resources/views/admin/video-article.blade.php ENDPATH**/ ?>