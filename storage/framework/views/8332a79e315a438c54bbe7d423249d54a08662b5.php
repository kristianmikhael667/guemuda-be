                            ...
                            <div class="d-widget">
                                <div class="d-widget-title">
                                    <div class="d-flex justify-content-between">
                                        <div>
                                            <h4>Category Program</h4>
                                        </div>
                                        <div>
                                            <a href="/administrator/category-program/create" id="create-new-post"
                                                class="btn btn-primary">Create Category Program</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="d-widget-title">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mike/laravel/Gue-Muda/resources/views/admin/category-program.blade.php ENDPATH**/ ?>