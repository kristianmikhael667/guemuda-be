                        ...
                        <div class="col-lg-12">
                            <div class="d-widget">
                                <form method="post" enctype="multipart/form-data"
                                    action="/administrator/webinars/<?php echo e($webinar->slug); ?>">
                                            ...
                                            <fieldset class="uk-fieldset mt-3">
                                                <div class="uk-margin">
                                                    ...
                                                    <input class="uk-input" name="title" id="title" type="text" required
                                                        value="<?php echo e(old('title', $webinar->title)); ?>">
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="uk-margin">
                                                    ...
                                                    <input class="uk-input" name="slug" id="slug" type="text" required
                                                        value="<?php echo e(old('slug', $webinar->slug)); ?>">
                                                    <?php $__errorArgs = ['title'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                                                    ...
                                                    <textarea class="uk-textarea" name="description" id="createnews"
                                                        rows="12"><?php echo e(old('description', $webinar->description)); ?></textarea>
                                                </div>
                                                <div class="uk-margin">
                                                    <div class="uk-margin" id="imagepost">
                                                        ...
                                                        <input type="hidden" name="oldImage"
                                                            value="<?php echo e($webinar->avatar); ?>">

                                                        <input type="file" name="avatar" id="avatar" class="dropify"
                                                            data-max-file-size="2M" data-default-file=<?php echo e(url('/api/image/' . $images)); ?>>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="uk-margin" id="survey-question" style="display: none">
                                                        <div class="uk-margin">
                                                            ...
                                                            <input class="uk-input" name="survey_question1"
                                                                ...
                                                                value="<?php echo e(old('question1', $webinar->survey_question1)); ?>" />
...
unset($__errorArgs, $__bag); ?>
                                                        ...
                                                        <div class="uk-margin">
                                                            ...
                                                            <input class="uk-input" name="survey_question2"
                                                                id="question2" type="text" value="<?php echo e(old('question2', $webinar->survey_question2)); ?>
...
unset($__errorArgs, $__bag); ?>
                                                        ...
                                                        <div class="uk-margin">
                                                            ...
                                                            <input class="uk-input" name="survey_question3"
                                                                id="question3" type="text" value="<?php echo e(old('question3', $webinar->survey_question3)); ?>
...
unset($__errorArgs, $__bag); ?>
                                                        ...
                                                        <div class="uk-margin">
                                                            ...
                                                            <input class="uk-input" name="survey_question4"
                                                                id="question4" type="text" value="<?php echo e(old('question4', $webinar->survey_question4)); ?>
...
unset($__errorArgs, $__bag); ?>
                                                        ...
                                                        <div class="uk-margin">
                                                            ...
                                                            <input class="uk-input" name="survey_question5"
                                                                id="question5" type="text" value="<?php echo e(old('question5', $webinar->survey_question5)); ?>
...
unset($__errorArgs, $__bag); ?>
                                                        ...
                                                        <div class="uk-margin">
                                                            ...
                                                            <input class="uk-input" name="survey_question6"
                                                                id="question6" type="text" value="<?php echo e(old('question6', $webinar->survey_question6)); ?>
...
unset($__errorArgs, $__bag); ?>
                                                        ...
                                                        <div class="uk-margin">
                                                            ...
                                                            <input class="uk-input" name="survey_question7"
                                                                id="question7" type="text" value="<?php echo e(old('question7', $webinar->survey_question7)); ?>
...
unset($__errorArgs, $__bag); ?>
                                                        ...
                                                        <div class="uk-margin">
                                                            ...
                                                            <input class="uk-input" name="survey_question8"
                                                                id="question8" type="text" value="<?php echo e(old('question8', $webinar->survey_question8)); ?>
...
unset($__errorArgs, $__bag); ?>
                                                        ...
                                                        <div class="uk-margin">
                                                            ...
                                                            <input class="uk-input" name="survey_question9"
                                                                id="question9" type="text" value="<?php echo e(old('question9', $webinar->survey_question9)); ?>
...
unset($__errorArgs, $__bag); ?>
                                                        ...
                                                        <div class="uk-margin">
                                                            ...
                                                            <input class="uk-input" name="survey_question10"
                                                                id="question10" type="text" value="<?php echo e(old('question10', $webinar->survey_question10)); ?>
...
unset($__errorArgs, $__bag); ?>
                                                        ...
                                                        <div class="uk-margin">
                                                            ...
                                                            <input class="uk-input" name="survey_question11"
                                                                id="question11" type="text" value="<?php echo e(old('question11', $webinar->survey_question11)); ?>

                                                            ">
                                                            <?php $__errorArgs = ['survey_question11'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                                        ...
                                                        <div class="uk-margin">
                                                            ...
                                                            <input class="uk-input" name="survey_question12"
                                                                id="question12" type="text" value="<?php echo e(old('question12', $webinar->survey_question12)); ?>

                                                            ">
                                                            <?php $__errorArgs = ['survey_question12'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                                        ...
                                                        <div class="uk-margin">
                                                            ...
                                                            <input class="uk-input" name="survey_question13"
                                                                id="question13" type="text" value="<?php echo e(old('question13', $webinar->survey_question13)); ?>

                                                            ">
                                                            <?php $__errorArgs = ['survey_question13'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                                        ...
                                                        <div class="uk-margin">
                                                            ...
                                                            <input class="uk-input" name="survey_question14"
                                                                id="question14" type="text" value="<?php echo e(old('question14', $webinar->survey_question14)); ?>

                                                            ">
                                                            <?php $__errorArgs = ['survey_question14'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                                        ...
                                                        <div class="uk-margin">
                                                            ...
                                                            <input class="uk-input" name="survey_question15"
                                                                id="question15" type="text" value="<?php echo e(old('question15', $webinar->survey_question15)); ?>

                                                            ">
                                                            <?php $__errorArgs = ['survey_question15'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                            ...
                                            <div class="uk-card uk-card-default uk-card-body">
                                                ...
                                                <div class="uk-card uk-card-hover mt-2">
                                                    <input class="uk-input" name="speaker2" id="speaker2" type="text"
                                                        ...
                                                        value="<?php echo e(old('speaker_2', $webinar->speaker_2)); ?>">
                                                </div>
                                            </div>
                                                ...
                                                <div class="uk-margin uk-grid-small uk-child-width-auto uk-grid">
                                                    <div class="row">
                                                        <label class="mr-2"><input class="uk-radio" name="typewebinar"
                                                                id="typewebinar1" <?php echo e($webinar->typewebinar == 0 ?
                                                            'checked' : ''); ?> value="0" type="radio">
                                                            Umum</label>
                                                        <label class="mr-2"><input class="uk-radio" name="typewebinar"
                                                                id="typewebinar2" value="1" <?php echo e($webinar->typewebinar ==
                                                            1 ?
                                                            'checked' : ''); ?> type="radio">
                                                            Premium</label>
                                                    </div>
