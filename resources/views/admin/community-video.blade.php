                        ...
                        <div class="col-lg-12">
                            <div class="d-widget">
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        @forelse ($communities as $num => $community)
                                        <?php 
                                        $explode_id = array_map('intval', explode(',', $community->tags_id));
                                        ?>
                                        <tr>
                                            <td>{{ $communities->firstItem() + $num }}</td>
                                            <td><a
                                                    href="/administrator/community-video/edittitle/{{ $community->slug }}">{{
                                                    $community->title
                                                    }}</a></td>
                                ...
                                <div class="d-flex justify-content-center">
                                    {{ $communities->links('vendor.pagination.default') }}
                                </div>
