                        ...
                        <div class="col-lg-12">
                            <div class="d-widget">
                                <form method="post" enctype="multipart/form-data"
                                    action="/administrator/category-webinars">
                                    <?php echo csrf_field(); ?>
                                    <div class="d-widget-title">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                <h4>Create Category Webinars</h4>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <fieldset class="uk-fieldset mt-3">
                                                <div class="uk-margin">
                                                    <input class="uk-input" name="name" id="name" type="text"
                                                        placeholder="Name Category Webinars">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <button type="submit" class="btn btn-primary">Save Category Webinars</button>
                                </form>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/guemuda.dewanhoster.my.id/resources/views/admin/create-category-webinars.blade.php ENDPATH**/ ?>