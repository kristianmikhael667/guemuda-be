                        ...
                        <div class="col-lg-12">
                            <div class="d-widget">
                                <form method="post" enctype="multipart/form-data"
                                    action="/administrator/admin/postadmin">
                                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                                                    ...
                                                    <input class="uk-input" value="<?php echo e($roles['name']); ?>"
                                                        name="rolesname" id="rolesname" type="hidden"
                                                        placeholder="Input Number">
                                                    <input class="uk-input" value="<?php echo e($roles['id']); ?>" name="roles"
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mike/laravel/gue-muda/resources/views/admin/createadmin.blade.php ENDPATH**/ ?>