...
<div class="theme-layout">
    <?php echo $__env->make('partials_superadmin.responsiveheader', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('partials_superadmin.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('partials_superadmin.topsubbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('partials_superadmin.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                ...
                                <table class="table-default table table-striped table-responsive-md">
                                    ...
                                    <tbody>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-xs"><span
                                                            class="avatar-initial rounded-circle bg-secondary">s</span>
                                                    </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-xs"><img src="images/resources/user2.jpg"
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-xs"><img src="images/resources/user6.jpg"
                                                            class="rounded-circle" alt=""></div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-xs"><span
                                                            class="avatar-initial rounded-circle bg-primary">r</span>
                                                    </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-xs"><span
                                                            class="avatar-initial rounded-circle bg-dark">d</span></div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-xs"><span
                                                            class="avatar-initial rounded-circle bg-purple">j</span>
                                                    </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-xs"><img src="images/resources/user8.jpg"
                                                            class="rounded-circle" alt=""></div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-xs"><img src="images/resources/user7.jpg"
                                                            class="rounded-circle" alt=""></div>
                        ...
                        <div class="col-lg-4">
                            <div class="d-widget mb-4">
                                ...
                                <div class="d-widget-content">
                                    ...
                                    <svg id="dolor-sign" xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                        stroke-linecap="round" stroke-linejoin="round"
                                        class="feather feather-dollar-sign earning">
                            ...
                            <div class="d-widget bg-danger uk-light">
                                ...
                                <div class="d-widget-content">
                                    <div class="violetion-message">
                                        <p>
                                            <i class="icofont-info-circle"></i> Report about the sex content violation
                                            of socimo
                                            <a class="button soft-danger circle" href="#" title="">Take Action</a>
                                        </p>
                                        <p>
                                            <i class="icofont-info-circle"></i> Report about abuse violation of socimo
                                            <a class="button soft-danger circle" href="#" title="">Take Action</a>
                                        </p>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mike/laravel/Gue-Muda/resources/views/superadmin/dashboard.blade.php ENDPATH**/ ?>