                            ...
                            <div class="d-widget">
                                <div class="d-widget-title">
                                    <div class="d-flex justify-content-between">
                                        <div>
                                            <h4>Premium Content Management</h4>
                                            
                                        </div>
                                        <div>
                                            <a href="/administrator/premiumcontent/create" id="create-new-post"
                                ...
                                <div class="d-widget-title">
                                    <div class="d-flex justify-content-between">
                                        <div>
                                            <form action="/administrator/premiumcontent" method="get" role="search">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mike/laravel/gue-muda/resources/views/admin/premiumcontent.blade.php ENDPATH**/ ?>