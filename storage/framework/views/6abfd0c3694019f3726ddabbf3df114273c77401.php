                        ...
                        <div class="col-lg-12">
                            <div class="d-widget">
                                <form method="post" enctype="multipart/form-data"
                                    action="/administrator/ads/<?php echo e($ads->uuid); ?>">
                                    ...
                                    <div class="uk-text-center" uk-grid>
                                        <div class="uk-width-expand@m">
                                            <fieldset class="uk-fieldset mt-3">
                                                <div class="uk-margin">
                                                    <input class="uk-input" value="<?php echo e(old('title', $ads->title)); ?>"
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="uk-margin">
                                                    <input class="uk-input mb-2 captions"
                                                        value="<?php echo e(old('title', $ads->link)); ?>" name="link" id="link"
...
unset($__errorArgs, $__bag); ?>
                                                    <textarea class="uk-textarea" name="desc" id="createnews" rows="12"
                                                        placeholder="Textarea"><?php echo e(old('desc', $ads->desc)); ?></textarea>
                                                </div>
                                            </fieldset>
                                        </div>
                                                ...
                                                <div class="uk-margin uk-grid-small uk-child-width-auto uk-grid">
                                                    <div class="row">
                                                        <label class="mr-2"><input class="uk-radio" name="type"
                                                                value="top" <?php echo e($ads->type == "top" ? 'checked' : ''); ?>

                                                            type="radio">
                                                            Top</label>
                                                        <label class="mr-2"><input class="uk-radio" name="type"
                                                                value="under" <?php echo e($ads->type == "under" ? 'checked' : ''); ?> type="radio">
                                                            Under</label>
                                                        <label class="mr-2"><input class="uk-radio" name="type"
                                                                value="left" <?php echo e($ads->type == "left" ? 'checked' : ''); ?>

                                                            type="radio">
                                                            Left</label>
                                                        <label class="mr-2"><input class="uk-radio" name="type"
                                                                value="right" <?php echo e($ads->type == "right" ? 'checked' : ''); ?> type="radio">
                                                            Right</label>
                                                    </div>
                                                </div>
                                            </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mike/laravel/gue-muda/resources/views/admin/ads-edit.blade.php ENDPATH**/ ?>