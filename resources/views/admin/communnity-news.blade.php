                        ...
                        <div class="col-lg-12">
                            <div class="d-widget">
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        @forelse ($communitys as $num => $community)
                                        <?php 
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ \Carbon\Carbon::parse($community->updated_at)->diffForHumans() }}</td>
                                            <td>
                                                <a href="/dashboard/posts/{{ $community->slug }}" class="badge btn-light">
                                ...
                                <div class="d-flex justify-content-center">
                                    {{ $communitys->links('vendor.pagination.default') }}
                                </div>
