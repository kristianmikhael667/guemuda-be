<?php return array (
  ...
  array (
    ...
    'fallback_locale' => 'en',
    'faker_locale' => 'en_US',
    'key' => 'base64:H5Gnpd6j/C4lS8OF0fRHTyEpXs+i3UYomP49NuW8DLg=',
    'cipher' => 'AES-256-CBC',
    'providers' => 
    array (
  ...
  array (
    ...
    array (
      ...
      array (
        'driver' => 'file',
        'path' => '/var/www/guemuda.dewanhoster.my.id/storage/framework/cache/data',
      ),
      'memcached' => 
      array (
        'driver' => 'memcached',
  ...
  array (
    ...
    array (
      ...
      array (
        'driver' => 'local',
        'root' => '/var/www/guemuda.dewanhoster.my.id/storage/app',
      ),
      'public' => 
      array (
        'driver' => 'local',
    ...
    'links' => 
    array (
      '/var/www/guemuda.dewanhoster.my.id/public/storage' => '/var/www/guemuda.dewanhoster.my.id/storage/app/public',
    ),
  ),
  'fortify-options' => 
  array (
  ...
  array (
    ...
    array (
      ...
      array (
        'driver' => 'single',
        'path' => '/var/www/guemuda.dewanhoster.my.id/storage/logs/laravel.log',
        'level' => 'debug',
      ),
      'daily' => 
      array (
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'port' => '2525',
        'encryption' => 'tls',
        'username' => '91a91641b1b3c9',
        'password' => '9476f1d955a47c',
        'timeout' => NULL,
        'auth_mode' => NULL,
      ),
      'ses' => 
    ...
    array (
      ...
      'paths' => 
      array (
        0 => '/var/www/guemuda.dewanhoster.my.id/resources/views/vendor/mail',
      ),
    ),
  ),
  'queue' => 
  ...
  array (
    ...
    'encrypt' => false,
    'files' => '/var/www/guemuda.dewanhoster.my.id/storage/framework/sessions',
    'connection' => NULL,
    'table' => 'sessions',
    'store' => NULL,
    'lottery' => 
  ...
  array (
    'paths' => 
    array (
      0 => '/var/www/guemuda.dewanhoster.my.id/resources/views',
    ),
    'compiled' => '/var/www/guemuda.dewanhoster.my.id/storage/framework/views',
  ),
  'visits' => 
  array (
    'engine' => 'eloquent',
  ...
  array (
    ...
    'storage' => 'files',
    'storage_files_path' => '/var/www/guemuda.dewanhoster.my.id/storage/clockwork',
    'storage_files_compress' => false,
    'storage_sql_database' => '/var/www/guemuda.dewanhoster.my.id/storage/clockwork.sqlite',
  ...
  array (
    ...
    'view_path' => '/var/www/guemuda.dewanhoster.my.id/resources/views/livewire',
    'layout' => 'layouts.app',
    'asset_url' => NULL,
    'app_url' => NULL,
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'database_path' => '/var/www/guemuda.dewanhoster.my.id/storage/app/geoip.mmdb',
      ...
      array (
        ...
        'secure' => true,
        'key' => NULL,
        'continent_path' => '/var/www/guemuda.dewanhoster.my.id/storage/app/continents.json',
        'lang' => 'en',
      ),
      'ipgeolocation' => 
      array (
