                        ...
                        <div class="col-lg-12">
                            <div class="d-widget">
                                <form method="post" enctype="multipart/form-data"
                                    action="/administrator/community-news/<?php echo e($contents->slug); ?>">
                                    <?php echo method_field('put'); ?>
                                    <?php echo csrf_field(); ?>
                                    <div class="d-widget-title">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                <h4>Edit Community Group</h4>
                                            </div>
                                        </div>
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                                                    ...
                                                    <input type="hidden" name="oldImage"
                                                        value="<?php echo e($contents->avatar); ?>">
                                                    <?php if($contents->avatar): ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <button type="submit" class="btn btn-primary">Update Comunity</button>
                                </form>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mike/laravel/gue-muda/resources/views/admin/community-edit.blade.php ENDPATH**/ ?>