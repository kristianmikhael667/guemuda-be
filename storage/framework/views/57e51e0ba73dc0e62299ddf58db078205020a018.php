                            ...
                            <div class="d-widget">
                                <div class="d-widget-title">
                                    <div class="d-flex justify-content-between">
                                        <div>
                                            <h4>Category Article</h4>
                                        </div>
                                        <div>
                                            <a href="/administrator/category-article/create" id="create-new-post"
                                                class="btn btn-primary">Create Category Article</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="d-widget-title">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/guemuda.dewanhoster.my.id/resources/views/admin/category-article.blade.php ENDPATH**/ ?>